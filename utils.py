#in this python file major technical functions will be performed such as generating summary generating statstic generating plots extrctions model trainning and so forth
import pandas as pd
import numpy as np
